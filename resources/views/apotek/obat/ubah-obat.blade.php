    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{url('detail-obat/'.$obat->id)}}" method="POST" role="form text-left">
                    @csrf
                    @method('put')
                    @if($errors->any())
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ $obat->kode_obat }}" type="text" placeholder="Kode" id="kode-obat" name="kode">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.name') border border-danger rounded-3 @enderror"">
                                    <input class="form-control" value="{{ $obat->nama_obat }}" type="text" placeholder="Nama Obat" id="nama-obat" name="nama">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Merk" id="number" name="phone" value="{{ $obat->merk }}">
                                        @error('phone')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="number" placeholder="harga" id="harga" name="harga" value="{{ $obat->harga_jual }}">
                                        @error('phone')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
